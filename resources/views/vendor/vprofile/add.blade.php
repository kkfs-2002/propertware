...
<div class="body-wrapper">
    <div class="pagetitle">
        <h1 class="ms-4 mt-2 p-2"><i class="fas fa-user-plus">Profile Update</i> </h1>
        <nav>
            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4">
                        <h5 class="card-title mb-4">Profile Update Form</h5>

                        <form action="{{ url('vendor/vprofile/add') }}" method="POST" enctype="multipart/form-data">
                            @csrf
